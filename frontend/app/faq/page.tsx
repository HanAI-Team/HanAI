...
const FAQ_LIST = [
  {
    ...
    answer:
      "Basic은 월 50건 청구 제한, 직원 계정 1개가 포함됩니다. Premium은 청구 건수 무제한, 직원 계정 무제한, 데이터 내보내기(CSV) 기능이 추가로 제공됩니다.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "모든 플랜에서 청구 파일(C2 전산매체) 생성이 가능합니다. Basic은 월 50건까지 청구할 수 있습니다.",
  },
  {
    question: "환자 데이터는 안전하게 보호되나요?",
    answer:
      "주민등록번호 등 민감 개인정보는 AES-256-GCM으로 암호화 저장됩니다. 국내 서버(AWS 서울 리전)에 보관하며 의료법 및 개인정보보호법을 준수합니다.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "토스페이먼츠를 통해 신용카드, 계좌이체 등 다양한 결제 수단을 지원하며 월 단위 자동 결제됩니다.",
  },
];
  ...
  return (
    <div className="bg-bg min-h-screen">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        <h1 className="text-2xl font-bold text-text mb-10">자주 묻는 질문</h1>
        ...
        <p className="text-sm text-subtext text-center mt-10">
          추가 문의는 sst@zinmac.kr로 연락해 주세요
        </p>
      </div>
    </div>
  );
